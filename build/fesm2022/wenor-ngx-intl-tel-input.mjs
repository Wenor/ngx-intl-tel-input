...
import { Injectable, Input, ChangeDetectionStrategy, ViewEncapsulation, Component, EventEmitter, Output, ElementRef, forwardRef, ViewChild, HostListener, NgModule } from '@angular/core';
...
class NgxIntlTelInputService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelInputService, deps: [{ token: CountryCode }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelInputService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelInputService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class NgxIntlTelFormService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelFormService, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelFormService }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelFormService, decorators: [{
            type: Injectable
        }] });

class NgxIntlTelModelAdapter {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelModelAdapter, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelModelAdapter }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelModelAdapter, decorators: [{
            type: Injectable
        }] });
...
class NgxDropdownService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxDropdownService, deps: [{ token: i1.Overlay }], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxDropdownService, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxDropdownService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelInputComponent, decorators: [{
            ...
            args: [{ selector: 'ngx-intl-tel-input', encapsulation: ViewEncapsulation.None, providers: [
                    ...
                    ], standalone: false, template: "<div class=\"ngx-intl-tel\"\n  [class.ngx-intl-tel_stroked]=\"stroked\"\n  [class.ngx-intl-tel_error]=\"invalid && (dirtyAndTouched || (ngxIntlTelForm.submitted$ | async))\"\n  [class.ngx-intl-tel_opened]=\"ngxDropdownService.menuState$ | async\"\n  [class.ngx-intl-tel_focus]=\"isFocused\">\n  @if (!disableCountrySelect) {\n    <ngx-intl-tel-trigger\n      class=\"ngx-intl-tel__trigger\"\n      [class.ngx-intl-tel__trigger_small]=\"small\"\n      #connectedElement\n      [country]=\"selectedCountry\"\n      [isError]=\"invalid && (dirtyAndTouched || (ngxIntlTelForm.submitted$ | async))\"\n      [isMenuOpened]=\"ngxDropdownService.menuState$ | async\"\n      [tooltipField]=\"tooltipField\"\n      [stroked]=\"stroked\"\n      (click)=\"openDropdown()\">\n    </ngx-intl-tel-trigger>\n  }\n  <mat-form-field [floatLabel]=\"floatLabel\"\n    class=\"ngx-intl-tel__form-field\"\n    [class.ngx-intl-tel__form-field_small]=\"small\">\n    <mat-label class=\"ngx-intl-tel__label\">\n      {{ inputLabel }}\n    </mat-label>\n    <input class=\"ngx-intl-tel__input\"\n      #focusable\n      matInput\n      type=\"tel\"\n      autocomplete=\"off\"\n      [id]=\"id\"\n      [ngClass]=\"cssClass\"\n      [disabled]=\"disabled\"\n      [placeholder]=\"removeDialCode(selectedCountry?.placeHolder || '')\"\n      [attr.maxLength]=\"maxLength\"\n      [attr.validation]=\"phoneValidation\"\n      [errorStateMatcher]=\"errorStateMatcher\"\n      [(ngModel)]=\"phoneNumber\"\n      (ngModelChange)=\"onPhoneNumberChange()\"\n      (blur)=\"onBlurEvent()\"\n      (focus)=\"onFocusEvent()\"\n      (keydown)=\"ngxIntlTelInputService.onInputKeyPress($event)\">\n      @if (clearIcon) {\n        <button\n          mat-icon-button\n          matSuffix\n          (click)=\"onClearClick($event)\">\n          <mat-icon>{{ clearIcon }}</mat-icon>\n        </button>\n      }\n      @if (matErrorContainer.children.length === 0 && hasError) {\n        <mat-error>\n          {{ (errors && errors[errorKey]) || control.getError(errorKey) }}\n        </mat-error>\n      }\n      <div #matErrorContainer>\n        <ng-content select=\"mat-error\"></ng-content>\n      </div>\n    </mat-form-field>\n    <ng-template #dropdownTemplate>\n      <div [class]=\"dropdownClass\">\n        <ngx-intl-tel-country [countries]=\"preferredCountriesInDropDown\"\n          [dropdownParams]=\"dropdownParamsData\"\n          [stroked]=\"stroked\"\n          (countryClick)=\"onCountrySelect($event, focusable)\">\n        </ngx-intl-tel-country>\n        @if (preferredCountriesInDropDown?.length) {\n          <mat-divider></mat-divider>\n        }\n        <ngx-intl-tel-country [countries]=\"ngxIntlTelInputService.allCountries\"\n          [dropdownParams]=\"dropdownParamsData\"\n          [stroked]=\"stroked\"\n          (countryClick)=\"onCountrySelect($event, focusable)\">\n        </ngx-intl-tel-country>\n      </div>\n    </ng-template>\n  </div>\n" }]
...
class ComponentsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: ComponentsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.13", ngImport: i0, type: ComponentsModule, declarations: [NgxIntlTelTriggerComponent, NgxIntlTelCountryComponent], imports: [CommonModule,
            MatIconModule,
            MatMenuModule,
            MatTooltipModule], exports: [NgxIntlTelTriggerComponent,
            NgxIntlTelCountryComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: ComponentsModule, imports: [CommonModule,
            MatIconModule,
            MatMenuModule,
            MatTooltipModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: ComponentsModule, decorators: [{
            type: NgModule,
            args: [{
...
class NgxIntlTelInputModule {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelInputModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelInputModule, declarations: [NgxIntlTelInputComponent], imports: [CommonModule,
            FormsModule,
            ReactiveFormsModule,
            MatFormFieldModule,
            MatInputModule,
    ...
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelInputModule, providers: [
            NgxIntlTelFormService,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.3.13", ngImport: i0, type: NgxIntlTelInputModule, decorators: [{
            type: NgModule,
            args: [{
