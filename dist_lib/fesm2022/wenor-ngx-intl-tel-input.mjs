...
class NgxIntlTelInputService {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: NgxIntlTelInputService, deps: [{ token: CountryCode }], target: i0.ɵɵFactoryTarget.Injectable }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: NgxIntlTelInputService, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: CountryCode }]; } });
...
class NgxIntlTelModelAdapter {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: NgxIntlTelModelAdapter, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: NgxIntlTelModelAdapter }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: NgxIntlTelModelAdapter, decorators: [{
            type: Injectable
        }] });
...
class NgxIntlTelInputComponent {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: NgxIntlTelInputComponent, deps: [{ token: NgxIntlTelInputService }, { token: NgxIntlTelFormService }, { token: NgxDropdownService }, { token: NgxIntlTelModelAdapter }, { token: i0.ViewContainerRef }, { token: i0.ChangeDetectorRef }, { token: i0.Injector }], target: i0.ɵɵFactoryTarget.Component }); }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: NgxIntlTelInputComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: NgxIntlTelInputService }, { type: NgxIntlTelFormService }, { type: NgxDropdownService }, { type: NgxIntlTelModelAdapter }, { type: i0.ViewContainerRef }, { type: i0.ChangeDetectorRef }, { type: i0.Injector }]; }, propDecorators: { onKeyPress: [{
                type: HostListener,
...
class ComponentsModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: ComponentsModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "16.0.3", ngImport: i0, type: ComponentsModule, declarations: [NgxIntlTelTriggerComponent, NgxIntlTelCountryComponent], imports: [CommonModule,
            MatIconModule,
            MatLegacyMenuModule,
            MatLegacyTooltipModule], exports: [NgxIntlTelTriggerComponent,
            NgxIntlTelCountryComponent] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: ComponentsModule, imports: [CommonModule,
            MatIconModule,
            MatLegacyMenuModule,
            MatLegacyTooltipModule] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "16.0.3", ngImport: i0, type: ComponentsModule, decorators: [{
            type: NgModule,
            args: [{
